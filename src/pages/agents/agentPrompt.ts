...
- cookie_types: GET/POST /admin/cookie-types ({name, sort, active, icon}), PATCH /admin/cookie-types/{id}, DELETE /admin/cookie-types/{id} (409 cookie_type_in_use with details.cookieCount when the type has cookies; set active false to hide it instead). Every write answers 409 event_live while an event is live.

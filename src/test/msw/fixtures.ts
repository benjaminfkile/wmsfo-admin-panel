...
// QR codes and places (contracts 4.5a). Two codes so tests can assert
// tag ordering and the unattached-with-scans warning.
export const places: Place[] = [
  {
    ...
    createdAt: NOW,
    updatedAt: NOW,
    audit: { action: "create", by: "person:" + AUTHOR, at: NOW },
  },
  {
    id: 2,
    parentId: 1,
    name: "West wing",
    description: "Between the fountain and the food court",
...
export const qrCodes: QrCode[] = [
  {
    ...
    attachment: {
      id: 500,
      placeId: 1,
      placePath: ["Southgate Mall"],
      since: NOW,
    },
    scans: { people: 7, flagged: 1, lastScanAt: NOW },
    createdBy: AUTHOR,
    createdAt: NOW,
    updatedAt: NOW,
    audit: { action: "create", by: "person:" + AUTHOR, at: NOW },
  },
  {
    ...
    opensSource: "home",
    attachment: null,
    scans: { people: 3, flagged: 0, lastScanAt: NOW },
    createdBy: AUTHOR,
    createdAt: NOW,
    updatedAt: NOW,
    audit: null,
...
export const qrCodeDetail: QrCodeDetail = {
  ...
  daily: Array.from({ length: 14 }, (_, i) => ({
    day: `2026-12-${String(9 + i).padStart(2, "0")}`,
    people: (i % 5) + 1,
  })),
};
